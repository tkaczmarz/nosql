...
[source,sh]
----
mongod --port 27001 --replSet carbon --dbpath data-1 --bind_ip localhost --smallfiles --oplogSize 128
mongod --port 27002 --replSet carbon --dbpath data-2 --bind_ip localhost --smallfiles --oplogSize 128
mongod --port 27003 --replSet carbon --dbpath data-3 --bind_ip localhost --smallfiles --oplogSize 128
----
